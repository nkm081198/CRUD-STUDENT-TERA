...
//    for(int i = 1; i<=3;i++) {
//      System.out.println("insert into campaign(id,label1_name,label2_name,label3_name,label4_name,label5_name,label6_name,label7_name,label8_name,label9_name,label10_name) values('1','label1NAME_id"+i+"','label2NAME_id"+i+"','label3NAME_id"+i+"','label4NAME_id"+i+"','label5NAME_id"+i+"','label6NAME_id"+i+"','label7NAME_id"+i+"','label8NAME_id"+i+"','label9NAME_id"+i+"','label10NAME_id"+i+"')");
//    }
      
    for(int i = 1; i<= 10; i++) {
      System.out.println("values('1','1','label1VALUE_id"+i+"','label2NAME_id"+i+"','label3NAME_id"+i+"','label4NAME_id"+i+"','label5NAME_id"+i+"','label6NAME_id"+i+"','label7NAME_id"+i+"','label8NAME_id"+i+"','label9NAME_id"+i+"','label10NAME_id"+i+"')");
    }
